...
_OCONUS_COUNTRIES: dict[str, str] = {
    ...
    "singapore": "Singapore", "australia": "Australia", "philippines": "Philippines",
    "thailand": "Thailand", "india": "India", "taiwan": "Taiwan",
    "germany": "Germany", "uk": "United Kingdom", "united kingdom": "United Kingdom",
    "england": "United Kingdom", "scotland": "United Kingdom", "ireland": "Ireland",
    "france": "France", "italy": "Italy", "spain": "Spain", "portugal": "Portugal",
    "netherlands": "Netherlands", "belgium": "Belgium", "luxembourg": "Luxembourg",
    "poland": "Poland", "romania": "Romania", "bulgaria": "Bulgaria", "greece": "Greece",
    ...
    "turkey": "Turkey", "israel": "Israel", "uae": "United Arab Emirates",
    "united arab emirates": "United Arab Emirates", "qatar": "Qatar",
    "bahrain": "Bahrain", "kuwait": "Kuwait", "saudi arabia": "Saudi Arabia",
    "oman": "Oman", "jordan": "Jordan", "iraq": "Iraq", "afghanistan": "Afghanistan",
    "egypt": "Egypt", "djibouti": "Djibouti", "kenya": "Kenya", "south africa": "South Africa",
...
_OCONUS_CITIES: dict[str, str] = {
    "ramstein": "Germany", "kaiserslautern": "Germany", "stuttgart": "Germany",
    "wiesbaden": "Germany", "grafenwoehr": "Germany", "vilseck": "Germany",
    "spangdahlem": "Germany", "frankfurt": "Germany", "berlin": "Germany",
    "munich": "Germany", "hamburg": "Germany",
    "aviano": "Italy", "vicenza": "Italy", "naples": "Italy", "rome": "Italy",
    "milan": "Italy", "sigonella": "Italy",
    "rota": "Spain", "moron": "Spain", "madrid": "Spain", "barcelona": "Spain",
    "lakenheath": "United Kingdom", "mildenhall": "United Kingdom",
    "menwith hill": "United Kingdom", "london": "United Kingdom",
    "fairford": "United Kingdom", "alconbury": "United Kingdom",
    "incirlik": "Turkey", "istanbul": "Turkey", "ankara": "Turkey",
    "tel aviv": "Israel", "jerusalem": "Israel",
    "doha": "Qatar", "al udeid": "Qatar", "manama": "Bahrain",
    "kuwait city": "Kuwait", "ali al salem": "Kuwait",
    "dubai": "United Arab Emirates", "abu dhabi": "United Arab Emirates",
    "kabul": "Afghanistan", "bagram": "Afghanistan",
    "baghdad": "Iraq", "erbil": "Iraq",
    "yokosuka": "Japan", "yokota": "Japan", "misawa": "Japan", "iwakuni": "Japan",
    "okinawa": "Japan", "kadena": "Japan", "futenma": "Japan", "atsugi": "Japan",
    "tokyo": "Japan", "aomori": "Japan", "sasebo": "Japan",
    "osan": "South Korea", "kunsan": "South Korea", "pyeongtaek": "South Korea",
    "humphreys": "South Korea", "yongsan": "South Korea", "seoul": "South Korea",
    "diego garcia": "British Indian Ocean Territory",
    "guam": "Guam (US territory)", "hagatna": "Guam (US territory)",
    "andersen": "Guam (US territory)",
    "sydney": "Australia", "canberra": "Australia", "melbourne": "Australia",
    "perth": "Australia", "darwin": "Australia",
...
def classify_oconus(location: str | None) -> bool:
    ...
    if classify_country(location) is not None:
        return True
    if _OCONUS_MARKERS.search(location):
        # Markers like "EMEA" / "APAC" / "International" — clearly OCONUS even
        # when no specific country resolves.
        return True
    return False
